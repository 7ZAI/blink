...
/**
 * Map<String, String> 类型 JSON TypeHandler
 *
 * @author binblink
 * @since 2026-04-16
 */
@Slf4j
public class MapStringHandler extends BaseTypeHandler<Map<String, String>> {
    ...
    public void setNonNullParameter(PreparedStatement ps, int i, Map<String, String> parameter, JdbcType jdbcType) throws SQLException {
        try {
            ...
            log.error("[MapString] JSON序列化失败", e);
    ...
    private Map<String, String> parseJson(String json) {
        ...
        try {
            ...
            log.error("[MapString] JSON反序列化失败, json: {}", json, e);
            return null;
        }
    }
}
