...
import com.blink.gateway.base.entity.SysOperationLogDO;
import com.blink.framework.core.data.CoreConstant;
import com.blink.log.constant.LogType;
import com.blink.gateway.base.mapper.SysOperationLogMapper;
...
public class SysOperationLogServiceImpl implements SysOperationLogService {
    ...
    private OperationLogVO convertToVO(SysOperationLogDO logDO) {
        ...
        // 设置执行状态描述
        vo.setExecuteStatusDesc(logDO.getExecuteStatus().equals(CommonConstants.EXECUTE_STATUS_SUCCESS) ? "成功" : "失败");
