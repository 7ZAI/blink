...
-- blink.sys_dict_type definition
...
-- blink.sys_dict_data definition
...
-- blink.sys_operation_log definition
...
(
    ...
    `log_type`          varchar(32)  NOT NULL DEFAULT 'OPERATION' COMMENT '日志类型: LOGIN-登入日志, SYSTEM-系统日志, OPERATION-操作日志',
    `description`       varchar(255) DEFAULT NULL COMMENT '操作描述',
    `request_url`       varchar(512) DEFAULT NULL COMMENT '请求URL',
    `request_method`    varchar(16)  DEFAULT NULL COMMENT '请求方法: POST/GET/PUT/DELETE等',
...
-- blink.sys_operation_log_history definition
...
-- blink.sys_role_menu_rela definition
...
-- blink.sys_user_preference definition
