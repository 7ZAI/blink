...
public class SysPermissionController {
    ...
    public ResponseDTO<QuerySysPermissionRspDTO> getSysPermissionList(@RequestBody @Validated RequestDTO<QuerySysPermissionReqDTO> reqDto) throws BlinkException {
