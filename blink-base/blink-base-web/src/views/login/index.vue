          ...
          <div class="footer-actions">
            <el-dropdown trigger="click" @command="handleLocaleChange">
              <div class="locale-switch">
                <BlinkIcon icon="mdi:translate" class="locale-icon" />
                <span>{{ currentLocaleLabel }}</span>
              </div>
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item command="zh_cn" :class="{ 'is-active': currentLocale === 'zh_cn' }">
                    {{ t('login.chinese') }}
                  </el-dropdown-item>
                  <el-dropdown-item command="en_us" :class="{ 'is-active': currentLocale === 'en_us' }">
                    {{ t('login.english') }}
                  </el-dropdown-item>
                </el-dropdown-menu>
              </template>
            ...
            <div class="theme-switch" @click="toggleTheme">
              ...
              <span>{{ themeStore.theme === 'dark' ? t('login.lightMode') : t('login.darkMode') }}</span>
            </div>
          </div>
...
import { User, Lock, Right, Moon, Sunny, ArrowRight, Check, Loading } from '@element-plus/icons-vue'
