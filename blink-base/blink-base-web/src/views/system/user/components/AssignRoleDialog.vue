  ...
  >
    <div v-loading="loading" class="dialog-content">
      ...
      <el-form :model="form" label-width="100px" class="role-form">
        <el-form-item :label="t('user.selectRole')">
          <el-select
            ...
            <div class="role-detail-content">
              <div class="detail-section">
                <div class="section-header">
                  <el-icon><Key /></el-icon>
                  <span>{{ t('user.permissionList') }}</span>
      ...
      <el-empty v-else :description="t('user.pleaseSelectRoleToView')" :image-size="80" />
    </div>
...
const handleSubmit = async () => {
  ...
  if (!isSuperAdmin.value && form.value.roleIdList.includes(SUPER_ADMIN_ROLE_ID)) {
    ElMessage.warning(t('user.onlySuperAdminCanAssign'))
    return
  }
