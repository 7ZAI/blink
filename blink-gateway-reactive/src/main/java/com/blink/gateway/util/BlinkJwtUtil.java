...
public class BlinkJwtUtil {
    ...
    public static String generateToken(String username){
        ...
        return JWT.create().setPayload("username",username).sign(SIGNER);
    }
    ...
    public static void main(String[] args) {
        System.out.println(generateToken("123123"));

//       JWT jwt = JWT.of("eyJ0eXAiOiJKV1QiLCJhbGciOiJQUzI1NiJ9.eyJ1c2VybmFtZSI6IjEyMzEyMyJ9.JD-nTUY8PUtBWv7L3BLGLMKkiCWTgc56gga1EDOxAfUDp2W6UwxPKHzRn_Mmkj9W_5rxDjcbQSKgbuSTmkLdiElYtPt30Zik1KIeXvrM_YdfYx10MW9KPsIjQGUdIBTIfxC8OLj7eLhJ2fNgCWRc0IGYmqbM9C2PhKTA_VueXnc");
