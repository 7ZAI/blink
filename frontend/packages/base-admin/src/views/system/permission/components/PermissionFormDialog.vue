  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px" class="permission-form">
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item :label="t('permission.acEnName')" prop="acEnName">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="t('permission.acIdentity')" prop="acIdentity">
      ...
      <!-- 接口权限字段 -->
      <el-form-item v-if="currentAcType === 1" :label="t('permission.url')" prop="url">
      ...
      <div v-else-if="currentAcType === 2" class="data-filter-section">
        <div class="section-title">{{ t('permission.dataFilterRule') }}</div>
...
const dialogTitle = computed(() =>
  props.type === 'add' ? t('permission.addPermission') : t('permission.editPermission')
)
