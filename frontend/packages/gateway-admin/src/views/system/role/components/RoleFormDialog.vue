    ...
    <div v-loading="loading" class="role-form-container">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px" class="role-form">
        <el-row :gutter="16">
          ...
          <el-col :span="12">
            <el-form-item :label="t('system.role.roleEnName')" prop="roleEnName">
          ...
          <el-col :span="12">
            <el-form-item :label="t('common.status')" prop="status">
              <el-radio-group v-model="form.status">
                <el-radio :value="0">{{ t('system.role.statusEnable') }}</el-radio>
                <el-radio :value="1">{{ t('system.role.statusDisable') }}</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
...
const dialogTitle = computed(() =>
  props.type === 'add' ? t('system.role.addRole') : t('system.role.editRole')
)
