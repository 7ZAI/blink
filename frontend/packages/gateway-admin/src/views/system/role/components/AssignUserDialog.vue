<template>
  <el-dialog
    :title="t('system.role.assignUser')"
    v-model="visible"
    width="900px"
  ...
  >
    <div class="user-selector-content">
      ...
      >
        ...
        <el-table-column :label="t('system.user.sex')" width="80" align="center">
          <template #default="{ row }">
            <span v-if="row.sex === 1">{{ t('system.user.male') }}</span>
            <span v-else-if="row.sex === 2">{{ t('system.user.female') }}</span>
