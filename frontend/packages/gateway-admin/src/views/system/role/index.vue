    ...
    <el-card class="table-card" shadow="never">
      <template #header>
        <div class="table-header">
          <AuthButton
            :has-permission="() => checkPermission(ButtonPerms.Role.Add)"
            type="primary"
            @click="handleAdd"
          >
          ...
          <AuthButton
            ...
            :has-permission="() => checkPermission(ButtonPerms.Role.Delete)"
            type="danger"
        ...
        >
          ...
          >
            <template #default="{ row }">
              <el-tag v-if="row.roleType === 1" type="primary">
          ...
          <el-table-column :label="t('common.operation')" min-width="400" fixed="right">
            <template #default="{ row }">
              <div class="operation-buttons">
                <AuthButton
                  v-if="row.roleId !== 1"
                  :has-permission="() => checkPermission(ButtonPerms.Role.Edit)"
                  type="primary"
                  link
                  size="small"
                ...
                <AuthButton
                  v-if="row.roleId !== 1"
                  :has-permission="() => checkPermission(ButtonPerms.Role.AssignPerm)"
                  type="warning"
                  link
                  size="small"
                ...
                >
                  <el-icon><Key /></el-icon>
                  {{ t('system.role.assignDataPermission') }}
                </AuthButton>
                <AuthButton
                  v-if="row.roleId !== 1"
                  :has-permission="() => checkPermission(ButtonPerms.Role.AssignMenu)"
                  type="success"
                  link
                  size="small"
                ...
                <AuthButton
                  :has-permission="() => checkPermission(ButtonPerms.Role.Detail)"
                  type="info"
                  link
                  size="small"
