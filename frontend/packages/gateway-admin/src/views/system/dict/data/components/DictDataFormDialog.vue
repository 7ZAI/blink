    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="100px" class="dict-data-form">
      ...
      <el-form-item :label="t('dict.listClass')" prop="listClass">
        ...
        >
          ...
          <el-option :label="t('dict.listClassInfo')" value="info" />
          <el-option :label="t('dict.listClassWarning')" value="warning" />
          <el-option :label="t('dict.listClassDanger')" value="danger" />
        </el-select>
      </el-form-item>
