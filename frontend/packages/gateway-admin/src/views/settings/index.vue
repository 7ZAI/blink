    ...
    <el-card shadow="never" class="rounded-lg">
      <template #header>
        <div class="card-header flex items-center justify-between">
          <span class="text-base font-semibold">{{ t('settings.title') }}</span>
        </div>
      </template>
            ...
            <el-form-item :label="t('settings.theme')">
              <div class="theme-options flex gap-6">
                ...
                <div
                  ...
                  :class="{ 'border-primary bg-primary-light': themeStore.mode === 'light' }"
                ...
                <div
                  class="theme-option flex flex-col items-center gap-2 p-4 border-2 rounded-lg cursor-pointer transition-all"
                  :class="{ 'border-primary bg-primary-light': themeStore.mode === 'dark' }"
                  @click="setTheme('dark')"
                >
