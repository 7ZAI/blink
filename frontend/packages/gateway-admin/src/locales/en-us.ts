export default {
  ...
  route: {
    ...
    routeGroupPlaceholder: 'Please select route group',
    allGroups: 'All Groups',
    viewTable: 'Table',
    viewJson: 'JSON',
    viewYaml: 'YAML',
    syncGroupRoutes: 'Sync Group Routes',
    syncGroupRoutesTip: 'Sync routes from instance to current group (incremental sync: add + update)',
    selectInstanceToSync: 'Select instance to sync',
    syncRoutesSuccess: 'Sync successful, added {added}, updated {updated}',
    noRoutesToSync: 'No routes to sync from instance',
    ...
    fetchInstanceRoutes: 'Fetch Instance Routes',
    selectInstanceToFetch: 'Select instance to fetch routes',
    instanceRoutesList: 'Instance Routes ({count} routes)',
    importSelectedRoutes: 'Import Selected',
    noInstanceRoutes: 'No routes in this instance',
    selectRouteToImport: 'Select routes to import',
    allRoutesExist: 'All selected routes already exist in repository',
    alreadyExists: 'Exists',
    // Push diff comparison
    pushGroupRoutes: 'Push Group Routes',
    pushGroupRoutesTip: 'Push all enabled routes in current group to instances',
    selectGroupFirst: 'Please select a route group first',
    viewDiff: 'View Diff',
    diffStats: 'Diff Stats',
    addedRoutes: 'Added Routes',
    modifiedRoutes: 'Modified Routes',
    deletedRoutes: 'Routes to Delete',
    unchangedRoutes: 'Unchanged Routes',
    noDiff: 'No differences, routes are consistent',
    ...
    oldValue: 'Old Value',
    newValue: 'New Value',
    pushConfirmMessage: 'Pushing {count} routes to {instanceCount} instances, continue?',
    validateAllInstances: 'Validate All Instances',
    validateSuccessMsg: 'Validation passed, all instances consistent',
    validateFailedMsg: 'Validation failed, some instances inconsistent',
    instanceValidateResult: 'Instance Validation Result',
    missingRoutes: 'Missing Routes',
    extraRoutes: 'Extra Routes',
  },
  pushRoute: {
    title: 'Push Routes',
    subtitle: 'Select routes from repository to push to gateway instances',
    routesFromRepository: 'Route Repository',
    gatewayInstances: 'Gateway Instances',
    selectedRoutes: '{count} routes selected',
    totalRoutes: '{count} total',
    selectedInstances: '{count} instances selected',
    onlineInstances: '{count} online',
    noRoutes: 'No routes to push',
    noInstances: 'No gateway instances',
    noResult: 'No push result yet, please push first',
    push: 'Push',
    fullPush: 'Full Push',
    fullPushConfirm: 'Push to all online instances?',
    validate: 'Validate',
    ...
    validateConsistent: 'All instance route configurations are consistent with pushed content',
    expected: 'Expected',
    actual: 'Actual',
    selectRoutesAndInstances: 'Please select routes and target instances',
    routeDetail: 'Route Detail',
    routePreview: 'Route Preview',
    noRoutesSelected: 'Please select routes to push',
    selectedRoutesCount: '{count} routes selected',
    targetInstancesCount: '{count} target instances',
    // New fields
  ...
  instanceRoute: {
    ...
    latestPushHistory: 'Latest Push History',
    noPushHistory: 'No push history',
    routeCount: '{count} routes',
    validateSuccess: 'Validation Passed',
    validateFailed: 'Validation Failed',
    allRoutesConsistent: 'All route configurations are consistent',
    error: 'Error',
    expected: 'Expected',
    actual: 'Actual',
    executeValidate: 'Execute Validate',
    clickToValidate: 'Click to execute validation',
    // Compare panel
    compare: 'Compare',
    executeCompare: 'Execute Compare',
    clickToCompare: 'Click to execute compare',
  ...
  pushHistory: {
    ...
    routesGroupPlaceholder: 'Enter routes group',
    pushResult: 'Push Result',
    pushResultColumn: 'Push Result',
  ...
  instance: {
    ...
    gracefulOfflineTitle: 'Graceful Offline Instance',
    forceOfflineTitle: 'Force Offline Instance',
    offlineStarting: 'Starting offline process...',
    offlineStepSending: 'Sending offline request',
    offlineStepDraining: 'Waiting for traffic drain',
    offlineStepWaiting: 'Waiting for status change',
    offlineStepComplete: 'Offline complete',
    offlineStepTimeout: 'Wait timeout, please refresh',
    offlineFailed: 'Offline failed',
    // Online progress dialog
    onlineTitle: 'Online Instance',
    onlineStarting: 'Starting online process...',
    onlineStepSending: 'Sending online request',
    onlineStepWaiting: 'Waiting for health check',
    onlineStepComplete: 'Online complete',
    onlineStepTimeout: 'Wait timeout, please refresh',
    onlineFailed: 'Online failed',
    offlineBackground: 'Offline task running in background',
    // Route group related
