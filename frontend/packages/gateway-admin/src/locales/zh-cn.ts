export default {
  ...
  route: {
    ...
    editRoute: '编辑路由',
    routeGroup: '路由分组',
    routeGroupPlaceholder: '请选择路由分组',
    allGroups: '全部分组',
    viewTable: '列表',
    viewJson: 'JSON',
    viewYaml: 'YAML',
    syncGroupRoutes: '同步分组路由',
    syncGroupRoutesTip: '从实例同步路由到当前分组（增量同步：新增+更新）',
    selectInstanceToSync: '请选择要同步的实例',
    syncRoutesSuccess: '同步成功，新增 {added} 条，更新 {updated} 条',
    noRoutesToSync: '实例无路由可同步',
    ...
    alreadyExists: '已存在',
    // 推送差异对比
    pushGroupRoutes: '推送分组路由',
    pushGroupRoutesTip: '推送当前分组下所有启用路由到实例',
    selectGroupFirst: '请先选择路由分组',
    viewDiff: '查看差异',
    diffStats: '差异统计',
    addedRoutes: '新增路由',
    modifiedRoutes: '修改路由',
    deletedRoutes: '将删除路由',
    unchangedRoutes: '不变路由',
    noDiff: '无差异，路由配置一致',
    ...
    oldValue: '旧值',
    newValue: '新值',
    pushConfirmMessage: '即将推送 {count} 条路由到 {instanceCount} 个实例，是否继续？',
    validateAllInstances: '校验所有实例',
    validateSuccessMsg: '校验成功，所有实例路由一致',
    validateFailedMsg: '校验失败，部分实例路由不一致',
    instanceValidateResult: '实例校验结果',
    missingRoutes: '缺失路由',
    extraRoutes: '多余路由',
  },
  pushRoute: {
  ...
  instance: {
    ...
    // 下线进度弹窗
    gracefulOfflineTitle: '优雅下线实例',
    forceOfflineTitle: '强制下线实例',
    offlineStarting: '开始下线流程...',
    offlineStepSending: '发送下线请求',
    offlineStepDraining: '等待流量排空',
    offlineStepWaiting: '等待状态变更',
    offlineStepComplete: '完成下线',
    offlineStepTimeout: '等待超时，请刷新查看',
    offlineFailed: '下线失败',
    // 上线进度弹窗
    onlineTitle: '上线实例',
    onlineStarting: '开始上线流程...',
    onlineStepSending: '发送上线请求',
    onlineStepWaiting: '等待健康状态检查',
    onlineStepComplete: '完成上线',
    onlineStepTimeout: '等待超时，请刷新查看',
    onlineFailed: '上线失败',
    offlineBackground: '下线任务转入后台执行',
    // 路由分组相关
    groupKey: '路由分组',
    storageMode: '路由存储',
