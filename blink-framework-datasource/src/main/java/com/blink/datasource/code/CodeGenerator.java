...
//                        .logicDeleteColumnName()
    ...
    public static void generate() {
        loadYmltoGenera("datasource-dev.yml", System.getProperty("user.dir"));
    }
    ...
    public static void generate(String acProfile, String path) {
        ...
        loadYmltoGenera("datasource-" + acProfile + ".yml", path);
    }

    private static void loadYmltoGenera(String res, String path) {
